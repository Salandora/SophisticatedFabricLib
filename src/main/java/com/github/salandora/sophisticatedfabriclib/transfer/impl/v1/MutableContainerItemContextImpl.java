package com.github.salandora.sophisticatedfabriclib.transfer.impl.v1;
...
public class MutableContainerItemContextImpl implements MutableContainerItemContext {
	private final Slot slot;

	public MutableContainerItemContextImpl(ItemStack stack) {
