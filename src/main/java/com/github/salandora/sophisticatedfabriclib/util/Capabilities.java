...
import com.github.salandora.sophisticatedfabriclib.transfer.api.v1.wrapper.items.ShulkerInvWrapper;
...
public class Capabilities {
	public static class ItemHandler {
		 ...
		 */
		public static final ItemApiLookup<IItemHandler, ContainerItemContext> ITEM = ItemApiLookup.get(SophisticatedFabricLib.id("item_item_storage"), IItemHandler.class, ContainerItemContext.class);

		/**
		 * Can be used to get an IItemHandler directly or through fallback to {@link ItemStorage#SIDED} with a wrapper
		 */
		public static final BlockApiLookup<IItemHandler, Direction> SIDED = BlockApiLookup.get(SophisticatedFabricLib.id("sided_block_storage"), IItemHandler.class, Direction.class);
		 ...
		 */
		public static final EntityApiLookup<IItemHandler, Void> ENTITY = EntityApiLookup.get(SophisticatedFabricLib.id("entity_item_storage"), IItemHandler.class, Void.class);
		 ...
		 */
		public static final EntityApiLookup<IItemHandler, Direction> ENTITY_AUTOMATION = EntityApiLookup.get(SophisticatedFabricLib.id("entity_automation_item_storage"), IItemHandler.class, Direction.class);
	...
	public static class FluidHandler {
		 ...
		 */
		public static final ItemApiLookup<IFluidHandlerItem, ContainerItemContext> ITEM = ItemApiLookup.get(SophisticatedFabricLib.id("item_fluid_storage"), IFluidHandlerItem.class, ContainerItemContext.class);
		 ...
		 */
		public static final BlockApiLookup<IFluidHandler, Direction> SIDED = BlockApiLookup.get(SophisticatedFabricLib.id("block_fluid_storage"), IFluidHandler.class, Direction.class);
