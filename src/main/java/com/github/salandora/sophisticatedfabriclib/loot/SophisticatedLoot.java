...
public class SophisticatedLoot implements ModInitializer {
	public static final ResourceKey<Registry<MapCodec<? extends IGlobalLootModifier>>> GLOBAL_LOOT_MODIFIER_SERIALIZERS_KEY = SophisticatedFabricLib.key("global_loot_modifier_serializers");
	...
	public void onInitialize() {
		...
		LootTableEvents.MODIFY.register(last, (key, builder, source, provider) ->
				((SophisticatedLootTableBuilder) builder).sophisticatedFabricLibrary_setId(key.location()));
	}
