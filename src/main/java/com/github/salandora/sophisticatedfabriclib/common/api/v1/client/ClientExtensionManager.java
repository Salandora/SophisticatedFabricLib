...
public final class ClientExtensionManager {
	public static final BlockApiLookup<IClientBlockExtensions, Void> BLOCK_EXTENSIONS = BlockApiLookup.get(new ResourceLocation(SophisticatedFabricLib.MOD_ID, "block_extensions"), IClientBlockExtensions.class, Void.class);
