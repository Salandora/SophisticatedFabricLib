...
public abstract class LivingEntityMixin_LandingEffect {
	...
	public <T extends ParticleOptions> int sophisticatedLibrary$addLandingEffects(ServerLevel level, T type, double posX, double posY, double posZ, int particleCount, double xOffset, double yOffset, double zOffset, double speed, Operation<Integer> original, @Local(argsOnly = true) BlockState state, @Local(argsOnly = true) BlockPos pos) {
