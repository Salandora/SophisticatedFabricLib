package com.github.salandora.sophisticatedlibrary.common.mixin.tools;
...
public class ShearsItemMixin extends Item {
	...
	@Override
	public boolean sophisticatedLibrary$canPerformAction(ItemStack stack, ItemAbility itemAbility) {
