...
import com.github.salandora.sophisticatedfabriclib.event.api.v1.common.ItemEntityEvents;
...
public class ItemEntityEventsGameTest {
	...
	public void canPickupFiresFromPlayerTouchAndCanCancelPickup(GameTestHelper context) {
		...
		context.startSequence()
				...
				.thenExecute(() -> itemEntity.playerTouch(context.makeMockPlayer(GameType.SURVIVAL)))
